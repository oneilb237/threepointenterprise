...
export default function ThreePointIndustrial() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-2xl px-6">
          <div className="mb-8">
            <div className="text-6xl font-black tracking-tighter mb-4">
              <span className="text-amber-500">3PT</span>
            </div>
            <h1 className="text-5xl lg:text-6xl font-black tracking-tight mb-6">
              Industrial Crating <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-transparent bg-clip-text">Solutions</span>
            </h1>
          </div>
          
          <p className="text-xl text-slate-300 leading-relaxed mb-8 max-w-xl mx-auto">
            Custom and generic crates engineered for precision, durability, and speed. From concept to shipment, we deliver exactly what you need—<span className="text-amber-400 font-semibold">built to spec</span>.
          </p>

          <div className="space-y-4">
            <p className="text-amber-400 text-sm font-semibold tracking-wide animate-pulse">
      ...
      {/* Main Site Content - shows after splash */}
      ...
      <nav className="border-b border-slate-800 backdrop-blur-md sticky top-0 z-50 bg-slate-950/90">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex justify-between items-center">
          ...
          <a href="#contact" className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 px-7 py-2.5 rounded-lg text-sm font-bold transition shadow-lg hover:shadow-orange-500/20">
            Get Quote
          </a>
        </div>
      </nav>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-6xl lg:text-7xl font-black tracking-tight leading-tight">
                  Built to <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-transparent bg-clip-text">Spec</span>
                </h1>
                <p className="text-xl text-slate-300 leading-relaxed max-w-lg">
                  Aircraft crating solutions that deliver precision, speed, and reliability. From custom designs to standard solutions—we build exactly what you need.
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-slate-200">Custom aircraft part crates</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-1 h-1 bg-amber-500 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group relative bg-slate-900/50 border border-slate-700 p-10 rounded-2xl hover:border-amber-500/50 transition duration-300 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-slate-300 leading-relaxed mb-6">
                  Standard, proven designs for routine shipments. Quick ordering, reliable solutions for common aircraft part requirements.
                </p>
            ...
            <div className="group relative bg-slate-900/50 border border-slate-700 p-10 rounded-2xl hover:border-amber-500/50 transition duration-300 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-slate-300 leading-relaxed mb-6">
                  Engineered specifically for your unique parts. Oversized, oddly shaped, or specialized handling—we design it perfectly.
                </p>
                <ul className="space-y-3 text-slate-400 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-900 border border-slate-700 p-10 rounded-2xl">
                ...
                <p className="text-slate-400 leading-relaxed">Dedicated full-time craftsman with deep aviation expertise. You get a partner who understands your industry.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div className="pt-2">
                ...
                <p className="text-slate-300 leading-relaxed max-w-xl">
                  Tell us about your part—dimensions, specifications, quantity. We'll respond quickly with a detailed quote that fits your timeline and budget.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-8">
              ...
              <div className="pt-2">
                ...
                <p className="text-slate-300 leading-relaxed max-w-xl">
                  Our expert builder engineers and constructs your crate with precision. Every detail matters. We keep you updated on progress.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-8">
              ...
              <div className="pt-2">
                ...
                <p className="text-slate-300 leading-relaxed max-w-xl">
                  Your finished crate is ready and ships on schedule. Your parts arrive safely, protected and ready for use.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-xl text-slate-400 leading-relaxed mb-10">
                Get in touch with our team. We'll discuss your requirements and provide a custom quote within 24 hours.
              </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition"
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition"
                      placeholder="Your Aviation Shop"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition h-28 resize-none"
                      placeholder="Describe your part, dimensions, quantity, timeline..."
                    />
                  </div>
                  <button 
                    type="submit"
                    className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 py-3 rounded-lg font-bold text-white transition shadow-lg hover:shadow-orange-500/30 text-base"
                  >
                    Send Quote Request
                  </button>
                </form>
